  ...
  <body>
    <div class="container">
      <div class="row coffee-machine">
        ...
        <div class="col-6 coffee-oper d-flex flex-column justify-content-around">
          <div class="row p-3">
            <div class="col-6">
            ...
            <div class="col-6">
              <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Сумма" aria-label="Сумма" aria-describedby="basic-addon2">
